...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::PHG4ScintillatorSlat*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("PHG4ScintillatorSlat", ::PHG4ScintillatorSlat::Class_Version(), "", 22,
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("PHG4ScintillatorSlat_Dict",
        ...
        TriggerDictionaryInitialization_PHG4ScintillatorSlat_Dict_Impl, {}, classesHeaders, /*has no C++ module*/false);
      isInitialized = true;
    }
  }
