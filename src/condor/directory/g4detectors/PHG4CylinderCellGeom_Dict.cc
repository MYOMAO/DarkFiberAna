...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::PHG4CylinderCellGeom*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("PHG4CylinderCellGeom", ::PHG4CylinderCellGeom::Class_Version(), "", 20,
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("PHG4CylinderCellGeom_Dict",
        ...
        TriggerDictionaryInitialization_PHG4CylinderCellGeom_Dict_Impl, {}, classesHeaders, /*has no C++ module*/false);
      isInitialized = true;
    }
  }
