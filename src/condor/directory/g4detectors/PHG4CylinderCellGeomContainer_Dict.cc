...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::PHG4CylinderCellGeomContainer*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("PHG4CylinderCellGeomContainer", ::PHG4CylinderCellGeomContainer::Class_Version(), "", 22,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<int,PHG4CylinderCellGeom*>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("map<int,PHG4CylinderCellGeom*>", -2, "map", 96,
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("PHG4CylinderCellGeomContainer_Dict",
        ...
        TriggerDictionaryInitialization_PHG4CylinderCellGeomContainer_Dict_Impl, {}, classesHeaders, /*has no C++ module*/false);
      isInitialized = true;
    }
  }
