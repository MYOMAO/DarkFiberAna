...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::PHG4CylinderCellv1*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("PHG4CylinderCellv1", ::PHG4CylinderCellv1::Class_Version(), "", 25,
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("PHG4CylinderCellv1_Dict",
        ...
        TriggerDictionaryInitialization_PHG4CylinderCellv1_Dict_Impl, {}, classesHeaders, /*has no C++ module*/false);
      isInitialized = true;
    }
  }
