...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::PHG4ScintillatorSlatv1*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("PHG4ScintillatorSlatv1", ::PHG4ScintillatorSlatv1::Class_Version(), "", 24,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const set<ULong64_t>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("set<ULong64_t>", -2, "set", 90,
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("PHG4ScintillatorSlatv1_Dict",
        ...
        TriggerDictionaryInitialization_PHG4ScintillatorSlatv1_Dict_Impl, {}, classesHeaders, /*has no C++ module*/false);
      isInitialized = true;
    }
  }
