...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::PHG4ScintillatorSlatContainer*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("PHG4ScintillatorSlatContainer", ::PHG4ScintillatorSlatContainer::Class_Version(), "", 25,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<unsigned int,PHG4ScintillatorSlat*>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("map<unsigned int,PHG4ScintillatorSlat*>", -2, "map", 96,
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("PHG4ScintillatorSlatContainer_Dict",
        ...
        TriggerDictionaryInitialization_PHG4ScintillatorSlatContainer_Dict_Impl, {}, classesHeaders, /*has no C++ module*/false);
      isInitialized = true;
    }
  }
