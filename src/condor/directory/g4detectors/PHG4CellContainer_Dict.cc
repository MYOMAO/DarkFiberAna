...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::PHG4CellContainer*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("PHG4CellContainer", ::PHG4CellContainer::Class_Version(), "", 24,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<unsigned long,PHG4Cell*>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("map<unsigned long,PHG4Cell*>", -2, "map", 96,
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("PHG4CellContainer_Dict",
        ...
        TriggerDictionaryInitialization_PHG4CellContainer_Dict_Impl, {}, classesHeaders, /*has no C++ module*/false);
      isInitialized = true;
    }
  }
