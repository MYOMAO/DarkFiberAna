...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::PHG4BlockGeomContainer*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("PHG4BlockGeomContainer", ::PHG4BlockGeomContainer::Class_Version(), "", 22,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<int,PHG4BlockGeom*>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("map<int,PHG4BlockGeom*>", -2, "map", 96,
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("PHG4BlockGeomContainer_Dict",
        ...
        TriggerDictionaryInitialization_PHG4BlockGeomContainer_Dict_Impl, {}, classesHeaders, /*has no C++ module*/false);
      isInitialized = true;
    }
  }
