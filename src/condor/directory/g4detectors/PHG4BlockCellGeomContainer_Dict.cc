...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::PHG4BlockCellGeomContainer*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("PHG4BlockCellGeomContainer", ::PHG4BlockCellGeomContainer::Class_Version(), "", 22,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<int,PHG4BlockCellGeom*>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("map<int,PHG4BlockCellGeom*>", -2, "map", 96,
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("PHG4BlockCellGeomContainer_Dict",
        ...
        TriggerDictionaryInitialization_PHG4BlockCellGeomContainer_Dict_Impl, {}, classesHeaders, /*has no C++ module*/false);
      isInitialized = true;
    }
  }
