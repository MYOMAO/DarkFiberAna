...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::PHG4CylinderCellContainer*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("PHG4CylinderCellContainer", ::PHG4CylinderCellContainer::Class_Version(), "", 25,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<unsigned int,PHG4CylinderCell*>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("map<unsigned int,PHG4CylinderCell*>", -2, "map", 96,
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("PHG4CylinderCellContainer_Dict",
        ...
        TriggerDictionaryInitialization_PHG4CylinderCellContainer_Dict_Impl, {}, classesHeaders, /*has no C++ module*/false);
      isInitialized = true;
    }
  }
