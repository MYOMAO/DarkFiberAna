...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::PHG4CylinderGeomContainer*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("PHG4CylinderGeomContainer", ::PHG4CylinderGeomContainer::Class_Version(), "", 22,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<int,PHG4CylinderGeom*>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("map<int,PHG4CylinderGeom*>", -2, "map", 96,
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("PHG4CylinderGeomContainer_Dict",
        ...
        TriggerDictionaryInitialization_PHG4CylinderGeomContainer_Dict_Impl, {}, classesHeaders, /*has no C++ module*/false);
      isInitialized = true;
    }
  }
