...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::PHG4BlockCellGeom*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("PHG4BlockCellGeom", ::PHG4BlockCellGeom::Class_Version(), "", 20,
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("PHG4BlockCellGeom_Dict",
        ...
        TriggerDictionaryInitialization_PHG4BlockCellGeom_Dict_Impl, {}, classesHeaders, /*has no C++ module*/false);
      isInitialized = true;
    }
  }
