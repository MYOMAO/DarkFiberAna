...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::PHG4CylinderCell*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("PHG4CylinderCell", ::PHG4CylinderCell::Class_Version(), "", 25,
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("PHG4CylinderCell_Dict",
        ...
        TriggerDictionaryInitialization_PHG4CylinderCell_Dict_Impl, {}, classesHeaders, /*has no C++ module*/false);
      isInitialized = true;
    }
  }
